...
public class GreetingController {
    ...
    public Greeting greeting(PatientArrivedMessage message) throws Exception {
        Thread.sleep(1000);
        return new Greeting("You have a consultation at: " + HtmlUtils.htmlEscape(message.getDateOfConsultation()) + ", patient's name is: " + HtmlUtils.htmlEscape(message.getPatientName()));
    }
}
